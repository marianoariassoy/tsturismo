...
const Home = () => {
  return (
    <section className='max-w-7xl m-auto py-20 px-4 relative'>
      <div className='max-w-3xl lg:absolute left-0 top-20 -z-10 mb-8 lg:mt-8 opacity-0 animate-fade-right'>
        <Slider />
      </div>
      <div className='flex items-end flex-col'>
        ...
        <div className='max-w-md mt-4 opacity-0 animate-fade-left animate-delay-300'>
